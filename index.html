...
<body >
            ...
            <div class="navbar-collapse collapse move-me">
                <ul class="nav navbar-nav navbar-right">
                    <li ><a href="#home">INICIO</a></li>
                     <li><a href="#testimonials-sec">TESTIMONIOS</a></li>
                    <li><a href="#faculty-sec">DESARROLLADORES</a></li>
                     <li><a href="#brand-sec">BRANDS</a></li>
					  <li><a href="#course-sec">CONTACTANOS</a></li>
 ...
 <div class="container">
               ...
               <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        <!-- Slider 01 -->
                        <li>
                              <h3>QUE TIENES EN MENTE COMPRAR?</h3>
                           <h1> VAMOS ENTRA</h1>
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> BIENVENIDO <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
         ...
         <div id="testimonials-sec" class="container set-pad" >
             <div class="row text-center">
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     <h1 data-scroll-reveal="enter from the bottom after 0.2s"  class="header-line">PORTAL DE REFACCIONES </h1>
                     <p data-scroll-reveal="enter from the bottom after 0.3s" >
                     Refacciones para Autos | Calidad de la Sierra
                         </p>
                 </div>
...
<div class="container">
           <div class="row" >
                    ...
                    <img class="img img-rounded img-responsive" src="assets/img/carrito.jpg"  style="width:2000px;height:500px;"/>
            ...
            <div style="color:white;background-color:#008CBA" class="modal-content">
              ...
              <div class="modal-body">
				 ...
				 <form role="form" method="post" action="register.php">
                   <fieldset>
							...
							<div class="form-group">
                                <input class="form-control" placeholder="Direccion" name="ruser_address" type="text" required>
							</div>
              ...
              <div class="modal-footer">
                ...
                <button class="btn btn-md btn-warning btn-block" name="register">Registrar</button>
				 ...
				 <button type="button" class="btn btn-md btn-success btn-block" data-dismiss="modal">Cancela</button>
				   </form>
              </div>
            </div>
          </div>
