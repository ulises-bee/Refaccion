        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li><a data-toggle="modal" data-target="#setAccount"> &nbsp; <span class='fa fa-gear'></span> Configuracion</a></li>
...
$query1=mysqli_connect("127.0.0.1","root","");
...
$rows=mysqli_num_rows(mysqli_query("SELECT * from items"));
